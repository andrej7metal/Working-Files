Public Class FrmCadastrarCliente
    ...
    Private Sub maskquarto_KeyPress(sender As Object, e As KeyPressEventArgs) Handles maskquarto.KeyPress
        If AscW(e.KeyChar) = Keys.Enter Then
            If maskquarto.Text <> Nothing Then
